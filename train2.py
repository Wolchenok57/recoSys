...
# Оптимизация
BASE_LR = 2e-5  # Чуть меньше для fine-tuning
MIN_LR = 1e-6
WEIGHT_DECAY = 0.1
GRAD_CLIP = 1.0
WARMUP_STEPS = 200
...
# Пути
PREV_LOG_DIR = "logs2"  # Откуда брать чекпоинт и валидационные ID
CUR_LOG_DIR = "logs2_2"  # Куда писать новые логи
CHECKPOINT_PATH = os.path.join(PREV_LOG_DIR, "model.pth")
VAL_IDS_PATH = os.path.join(PREV_LOG_DIR, "val_books.json")
